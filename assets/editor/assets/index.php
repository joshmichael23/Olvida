            ...
            <script type="application/ng-template" id="texture-upload-dialog-template">
                <md-dialog class="upload-file-dialog">
                    ...
                    <label class="pretty-upload">
                        ...
                        <i class="mdi mdi-cloud-upload"></i>
                        <span class="upload-button-label">Upload Template</span>
                    </label>
                </md-dialog>
            </script>
                ...
                <md-dialog class="upload-file-dialog">
                    <div ng-show="openImageMode === 'open'">
                        ...
                        <label class="pretty-upload">
                            ...
                            <i class="mdi mdi-cloud-upload"></i>
                            <span class="upload-button-label">Get Template</span>
                        </label>
                    ...
                    <div class="new-canvas" ng-show="openImageMode === 'create'">
                        ...
                        <div class="buttons">
                            ...
                            <md-button style="background-color: #3c8dbc" ng-click="createNewCanvas(canvasWidth, canvasHeight)" class="md-primary md-raised">Create</md-button>
                        </div>
                    </div>
                </md-dialog>
            </script>
