        ...
        <ul class="nav navbar-nav">
         ...
         <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
                  ...
                  <li class="header">You have <?php echo $count; ?> notification/s</li>
              ...
              <li class="footer"><a href="<?php echo base_url(); ?>Notifications/view/<?php echo $id . '/' . $status; ?>">View all</a></li>
            </ul>
          </li>
             ...
             <!--  <li class="user-header">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo base_url();?>Account/index" class="btn btn-default">Profile</a>
                </div><br><br>
                <div class="pull-right">
