      ...
      <div class="navbar-custom-menu">
        ...
        <!-- NOTIFICATIONS GO HERE -->
           <?php 
               ...
               $count = $CI->Connect_Db->countNotificationsSchool($id); 
            ?>
         ...
         <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <?php 
               ...
               $notifications = $CI->Connect_Db->getNotificationSchool($id);
...
<!--                   <?php echo $this->session->userdata('school_name') ?>
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo base_url();?>Account/index" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
