...
<div class="wrapper">
  ...
  <?php require_once('navbarSecretariat.php'); ?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php endif; ?> 
          <li><a href="<?php echo base_url();?>competitions/generateCertificate"><i class="fa fa-print"></i> Generate Certificate</a></li>
          <li><a href="<?php echo base_url();?>Feedbacks/viewCompFeedback"><i class="fa fa-edit"></i>Feedbacks</a></li></li>
