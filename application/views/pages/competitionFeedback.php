                                ...
                                <section class="content">
                                    ...
                                    <div class="box">
                                        <div class="box-header with-border">
                                            ...
                                            <form class="pull-right" method="post" action="<?php echo base_url('Feedbacks/viewCompFeedback'); ?>">
                                                  ...
                                                  <div class="col-lg-3 col-xs-6">
                                                      ...
                                                      <div class="small-box" id="box" href="awd">
                                                          ...
                                                          <span class="small-box-footer" style="background-color: rgb(53, 124, 165)">
                                                                <a style="color: white" href="<?php echo base_url() ?>Feedbacks/index/<?php echo $compID;?>" class="small-box-footer">View
