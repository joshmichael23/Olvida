          ...
          <div class="box">
            ...
            <div class="box-body">
                    ...
                    <div class="register-box-body">
                        <form method="post" action="<?php echo base_url() ?>Account/EditAccountDirector/<?php echo $accountID;?>" accept-charset="utf-8"> 
                          ...
                          <label>Username</label>
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control" name="ContactNo" value="<?php echo $contactno; ?>" class="form-control" type="text" width="25">
                            </div>
