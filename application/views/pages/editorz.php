    ...
    <body id="editor" ng-app="ImageEditor" ng-strict-di >
        ...
        <div ng-controller="MainController" ng-cloak style="height: 100%">
            <section id="right-panels">
                <section id="objects" class="md-whiteframe-z2" ng-controller="ObjectsPanelController">
                    ...
                    <div class="scrollbar-wrapper" ed-pretty-scrollbar ed-scroll-axis="y">
                        <ul class="objects-panel list-unstyled" ui-sortable="sortableOptions" ng-model="objects">
                            <li class="object panel-item" ng-repeat="object in objects" ng-click="setAsActive(object)" ng-if="!object.ignore">
                               ...
                               {{ object.text || spacify(object.name) || spacify(object.type)}}
                               <!-- working this for objectspanelcontroller -->
                    ...
                    <section id="text" data-index="2" class="tab" ng-controller="TextController">
                        ...
                        <div data-name="text" class="actions-menu wider md-whiteframe-z1" ng-class="isPanelEnabled() ? 'open' : 'closed'">
                            ...
                            <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }" ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light">
                                ...
                                <div class="buttons">
                                    <md-button ng-click="finishAddingTextToCanvas()" style="background-color: #3c8dbc" class="md-primary md-raised">Save</md-button>
                    ...
                    <section id="drawing" class="tab" data-index="3" ng-controller="DrawingController">
                        ...
                        <div id="brushes">
                            <div ng-repeat="brush in drawing.availableBrushes" ng-class="{ active: drawing.activeBrushName == brush }" class="brush" ng-click="changeBrush(brush, $event)">
                                <img title="{{ brush }}" class="img-responsive" ng-src="<?php echo base_url(); ?>assets/editor/assets/images/brushes/{{brush}}.png"/>
                            </div>
                        </div>
                        ...
                        <div data-name="drawing" class="actions-menu wider md-whiteframe-z1" ng-class="activePanel == 'drawing' ? 'open' : 'closed'">
                            ...
                            <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }" ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light">
                                ...
                                <div class="buttons">
                                    <md-button ng-click="finishAddingDrawingsToCanvas()" style="background-color: #3c8dbc" class="md-primary md-raised">Save</md-button>
...
<!--                     <div ng-repeat="sample in samples">
                    ...
                    <md-button ng-click="openUploadDialog2($event)" ng-if="!getParam('hideOpenButton')">Open</md-button>
                    ...
                    <md-button ng-click="openSaveDialog($event)" style="background-color: #3c8dbc" class="md-primary md-raised">Save</md-button>
                </section>
            ...
            <script src="<?php echo base_url(); ?>assets/editor/assets/js/scripts.min.js"></script>
            ...
            <script type="application/ng-template" id="texture-upload-dialog-template">
                <md-dialog class="upload-file-dialog">
                    ...
                    <label class="pretty-upload">
                        ...
                        <i class="mdi mdi-cloud-upload"></i>
                        <span class="upload-button-label">Upload Image</span>
                    </label>
                </md-dialog>
            </script>
            ...
            <script type="application/ng-template" id="main-image-upload-dialog-template-2">
                ...
                <md-dialog class="upload-file-dialog">
                    <div ng-show="openImageMode === 'open'">
                        ...
                        <div class="buttons" ng-show="!canOpenImage">
                            <md-button style="color: #3c8dbc" ng-click="openImageMode = 'create'" class="md-primary">Create New</md-button>
                        ...
                        <div ng-show="canOpenImage">
                            ...
                            <div class="buttons">
                                <md-button style="background-color: #3c8dbc" ng-click="openImage()" class="md-primary md-raised">Open</md-button>
                    ...
                    <div class="new-canvas" ng-show="openImageMode === 'create'" >
                        ...
                        <md-input-container>
                            <label style="color: #3c8dbc">Width</label>
                            <input min="1" max="5000" type="number" ng-model="canvasWidth">
                        </md-input-container>

                        <md-input-container>
                            <label style="color: #3c8dbc">Height</label>
                        ...
                        <div class="buttons">
                            ...
                            <md-button style="background-color: #3c8dbc" ng-init="compID='<?php echo $compID; ?>'; type='<?php echo $type; ?>'" ng-click="createNewCanvas(canvasWidth, canvasHeight, type, compID)" class="md-primary md-raised">Create
                            </md-button>
                        </div>
                    </div>
                </md-dialog>
